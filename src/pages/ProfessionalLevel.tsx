...
const ProfessionalLevel: React.FC = () => {
    return (
        <div>
            <Navbar />
            <main>
                <h1 className="bg-Header1 text-white w-[250px] text-[24px] font-bold text-center rounded-[10px] mt-[20px] mx-auto py-[11px]">
                    Professional Levels
                </h1>
                ...
                <div className="bg-mid mt-[20px]">
                    ...
                    <div className="flex justify-between px-[50px] py-[20px]">
                        ...
                        <button className="bg-deloitteGreen flex items-center text-white text-[12px] rounded-[25px] cursor-pointer">
